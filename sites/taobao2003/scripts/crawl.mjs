...
// 用法：node scripts/crawl.mjs http://127.0.0.1:3004 [会员名 密码]
...
async function get(url) {
  const res = await fetch(url, { headers: { cookie: cookieHeader(), 'user-agent': 'taobao2003-crawler' }, redirect: 'manual' });
  store(res);
