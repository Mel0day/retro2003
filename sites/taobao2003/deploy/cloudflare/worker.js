// taobao-2003.dshmod.com 的入口 Worker：把请求经 Workers VPC 转发到服务器上的 Cloudflare Tunnel。
...
function maintenancePage() {
  return new Response(
    '<!doctype html><meta charset="utf-8"><title>正在维护</title><p style="font:14px/1.8 SimSun,serif;text-align:center;margin-top:20vh">淘宝网 2003 正在维护，请稍后刷新。</p>',
...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      response = await env.ORIGIN.fetch(`http://taobao2003:3004${url.pathname}${url.search}`, {
